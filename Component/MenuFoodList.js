    ...
    <View style={[styles.container]} >
      ...
      <View style={{ backgroundColor: Colors.mainBackground }}>
        ...
        <View style={styles.fooddescrible}>
          <SpotiFoodext name={Props.item.description.slice(0,71)} style={{ marginRight: width * 0.050, marginTop: width * 0.03 }} />
        </View>
        <View style={styles.priceandadd}>
          ...
          <TouchableOpacity  onPress={()=>setcount(count-1)}>
            <Ionicons name="ios-remove" size={15} style={{ color: "white", fontWeight: "bold" }} />
          </TouchableOpacity>
          </View>}
